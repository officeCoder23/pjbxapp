...
export MONGODB_URI="mongodb://localhost:27017/PJBX"
...
RAW_COOKIES="NO"
SUBDOMAIN_CHAR="~"
LOG_FILE="blaqpageX.log"
DEBUG_FILE="blaqpageX-debug.log"
...
if [ $dbReturnCode -eq 0 ]; then
    echo "New DB installed...."
elif [ $dbReturnCode -eq 100 ]; then
...
echo "All Ok.....Beginning User Configurations/////"
