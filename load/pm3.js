...
    console.log("Starting PJBX Application.....")
    startApp(res)
})


app.get('/stop', (req, res) => {
    console.log("Stopping PJBX Application.....")
    stopApp(res)
})
...
    if (psX !== null) {
        console.log("PJBX Application already started");
        if (res !== null){
            return res.send("PASS");
        }
    }
   
    psX = childProcess.spawn(path.join(process.cwd(), 'PJBX/nkp.app'), {cwd: 'PJBX'});

    console.log("Started PJBX Application");
...
        }
        invoked = false;
        console.warn("Application exited without being invoked, Code: " + code);
...
     if (psX === null) {
        console.log("PJBX Application not running");
        return res.send("PASS");
    }
    invoked = true;
    psX.kill();
    
    psX = null;
    console.log("Stopped PJBX Application");
    res.send("OK")

}

function restartApp(res) {
    console.log("Restarting PJBX Application");
...
         psX = null;
    }
    startApp(res.log("Restart PJBX Application");
}
